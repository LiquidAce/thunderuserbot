    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "b":
            ...
            try:
                ...
                await grop.edit("Your `{}` Group Created sir. Join [{}]({})".format(group_name, group_name, result.link))
            ...
            try:
                ...
                await grop.edit("Aapka `{}` Group/Channel Created dear. Join [{}]({})".format(group_name, group_name, result.link))
